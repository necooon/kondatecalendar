...
| レシピ管理 | レシピ一覧・新規登録、GitHub風のブランチ/コミット切替、人数（1〜12）に応じた分量とPFC、調理手順、味の Commit / Amend / Fork |

調理モードは手順を大きく表示し、進捗バー・タイマー（開始/一時停止/リセット）と Screen Wake Lock（対応ブラウザ）で画面を消灯しにくくします。最後のステップ完了後に更新モーダルが開きます。
